...
function actualizarConfiguradorBases() {
    ...
    if (!lineaSelect) return; // Escudo por si no existe en el HTML
...
function agregarBaseConfigAlCarrito() {
    ...
    // --- RESETEO BLINDADO Y PRIORITARIO ---
    try {
        // Regresamos todo al índice 0 (la primera opción)
        ...
        // El truco de magia: Simular que el usuario cambió la opción manualmente
